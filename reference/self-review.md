...
1. **Run envelope.** Spell runs are time-boxed to **≤ 8 hours** of agent
   work per run; every run ends with a deliverable (draft, manuscript, or
   progress report) and a decision list for the user. Spell never operates
   autonomously across days or months. This resolves tension 1 and item 15
