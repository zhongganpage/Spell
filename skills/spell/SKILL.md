...
produces the next manuscript version. Full detail in the repository's
`reference/` folder (github.com/zhongganpage/Spell); paste-ready prompts in
`./modules/prompts.md`.
